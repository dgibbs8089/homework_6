$(document).ready(function () {
    //My unique id for the open weather API
    let appID = "8dc43ecdebe52087ddc8fa938f8cde93";
    let weather = "";
    let city = "";
    ...
    //Script for the submit-city function
...
$.getJSON(weather, function (json) {
    ...
    //Information to be displayed upon submission of city
...
function fiveDayForecast() {
    ...
    //Quick ajax script to grab the 5-day
$.ajax({
...
for (let i = 0; i < response.list.length; i++) {
    //Clears text area for new entry
...
search_history.forEach(function (city) {
    ...
    //Keeping second additions of the same city from occuring 
        console.log(search_history);
        let history_item = $("<li>");
